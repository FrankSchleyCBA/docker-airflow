...
DEFAULT_MAX_LOG_AGE_IN_DAYS = 14    # Length to retain the log files if not already provided in the conf. If this is set to 14, the job will remove those files that are 14 days old or odler
